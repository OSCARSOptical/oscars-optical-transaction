  ...
  return <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Input type="number" value={patient.age} onChange={e => onFieldChange('age', parseInt(e.target.value) || 0)} readOnly={!isEditing} />
        </div>
        <div>
        ...
        <div>
          ...
          <Input type="email" value={patient.email} onChange={e => onFieldChange('email', e.target.value)} readOnly={!isEditing} />
        </div>
